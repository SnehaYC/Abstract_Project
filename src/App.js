...
function Navbar() {
  ...
  const userRole = 'admin'; // You might want to replace this with actual user role management
      ...
      <div className="navbar-right">
        {isLoggedIn ? (
          <>
            ...
            {userRole === 'admin' && <Link className="nav-link" to="/dashboard/admin">Admin Dashboard</Link>}
...
function Home() {
  return (
    <div className="home-container">
      <h1 className="welcome-title">Welcome to TravelDesk</h1>
      <div className="home-links">
        <Link to="/login" className="home-link login-link">Login</Link>
